...
function shopContext(siteConfig = {}) {
    ...
    return {
        ...
        motoboltMaxKm: Number(siteConfig.motoboltMaxKm) === 40 ? 30 : (Number(siteConfig.motoboltMaxKm) || DEFAULT_SHOP.motoboltMaxKm)
    };
}
...
function youtubeDescription(shop, product, extra = '') {
    ...
    return [
        ...
        `📍 Envíos por Motobolt en Asunción y alrededores (hasta ${shop.motoboltMaxKm} km). Interior por transportadora.`,
        `🌐 ${shop.web}`,
...
- ${shop.name}, Paraguay. El local está en Capiatá, Ruta 1 Ex km 21. NUNCA digas que estamos en Asunción.
- Envíos Motobolt en Asunción y alrededores (hasta ${shop.motoboltMaxKm} km). Interior por transportadora.
