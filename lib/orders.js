...
const TRACKING_META = {
    ...
    esperando_motobolt: { title: 'Esperando Motobolt', detail: 'Pedí tu Motobolt. En 1 hora como máximo se despacha. Te pasamos la ubicación de Ferumishop.', icon: 'fa-motorcycle', tone: 'info' },
...
function thermalPedidoFromWebOrder(order) {
    ...
    return {
        ...
        qrPayload: `FERUMI|${order.ticketCode || ''}`,
...
function thermalPedidoFromTransaction(tx) {
    ...
    return {
        ...
        orderNumber: '',
        shippingLabel: '',
        qrPayload: `https://www.ferumi.shop/pedido/${tx._id}`,
        qrHint: 'Detalle delivery'
    };
}
